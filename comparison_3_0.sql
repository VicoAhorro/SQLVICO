...
WITH calculated_prices_3_0 AS (
  SELECT
    ...
    ((COALESCE(c30.power_p1,0::real) * COALESCE(cr.price_pp1,0::real) * COALESCE(c30.power_days,0::real))::double precision) +
    ((COALESCE(c30.power_p2,0::real) * COALESCE(cr.price_pp2,0::real) * COALESCE(c30.power_days,0::real))::double precision) +
    ((COALESCE(c30.power_p3,0::real) * COALESCE(cr.price_pp3,0::real) * COALESCE(c30.power_days,0::real))::double precision) +
    ((COALESCE(c30.power_p4,0::real) * COALESCE(cr.price_pp4,0::real) * COALESCE(c30.power_days,0::real))::double precision) +
    ((COALESCE(c30.power_p5,0::real) * COALESCE(cr.price_pp5,0::real) * COALESCE(c30.power_days,0::real))::double precision) +
    ((COALESCE(c30.power_p6,0::real) * COALESCE(cr.price_pp6,0::real) * COALESCE(c30.power_days,0::real))::double precision) AS total_power_price,
