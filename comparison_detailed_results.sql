...
SELECT
  ...
  b.totalconsumo as total_consumption,
  (COALESCE(b.anual_consumption_p1, 0) + COALESCE(b.anual_consumption_p2, 0) + COALESCE(b.anual_consumption_p3, 0))::real as total_anual_consumption,
  b.power_p1,
  b.power_p2,
...
SELECT
  ...
  NULL::real as "precio_kwh_P6",
  b.totalconsumo as total_consumption,
  b.anual_consumption as total_anual_consumption,
...
SELECT
  ...
  b."precio_kwh_P6",
  b.totalconsumo as total_consumption,
  (COALESCE(b.anual_consumption_p1,0)+COALESCE(b.anual_consumption_p2,0)+COALESCE(b.anual_consumption_p3,0)+COALESCE(b.anual_consumption_p4,0)+COALESCE(b.anual_consumption_p5,0)+COALESCE(b.anual_consumption_p6,0))::real as total_anual_consumption,
  b.power_p1,
  b.power_p2,
  b.power_p3,
  b.power_p4,
